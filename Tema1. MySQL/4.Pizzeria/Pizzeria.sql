...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Pizzas` (
  ...
  `Productos_Pedido_idProductos_Pedido` INT NOT NULL,
  `Categorias_Pizzas_idCategorias_Pizzas` INT NOT NULL,
  PRIMARY KEY (`idPizzas`, `Categorias_Pizzas_idCategorias_Pizzas`),
  INDEX `fk_Pizzas_Productos_Pedido1_idx` (`Productos_Pedido_idProductos_Pedido` ASC) VISIBLE,
  INDEX `fk_Pizzas_Categorias_Pizzas1_idx` (`Categorias_Pizzas_idCategorias_Pizzas` ASC) VISIBLE,
  UNIQUE INDEX `idPizzas_UNIQUE` (`idPizzas` ASC) VISIBLE,
  CONSTRAINT `fk_Pizzas_Productos_Pedido1`
    FOREIGN KEY (`Productos_Pedido_idProductos_Pedido`)
    REFERENCES `Pizzeria`.`Productos_Pedido` (`idProductos_Pedido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Hamburguesas` (
  ...
  INDEX `fk_Hamburguesas_Productos_Pedido1_idx` (`Productos_Pedido_idProductos_Pedido` ASC) VISIBLE,
  UNIQUE INDEX `idHamburguesas_UNIQUE` (`idHamburguesas` ASC) VISIBLE,
  CONSTRAINT `fk_Hamburguesas_Productos_Pedido1`
    FOREIGN KEY (`Productos_Pedido_idProductos_Pedido`)
    REFERENCES `Pizzeria`.`Productos_Pedido` (`idProductos_Pedido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Bebidas` (
  ...
  INDEX `fk_Bebidas_Productos_Pedido1_idx` (`Productos_Pedido_idProductos_Pedido` ASC) VISIBLE,
  UNIQUE INDEX `idBebidas_UNIQUE` (`idBebidas` ASC) VISIBLE,
  CONSTRAINT `fk_Bebidas_Productos_Pedido1`
    FOREIGN KEY (`Productos_Pedido_idProductos_Pedido`)
    REFERENCES `Pizzeria`.`Productos_Pedido` (`idProductos_Pedido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
