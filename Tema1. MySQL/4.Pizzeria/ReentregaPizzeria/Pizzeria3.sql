...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Pedidos` (
  ...
  `PEdiDomicilio_idPEdiDomicilio` INT NOT NULL,
  `Detalles_Producto_id_Detalle_Producto` INT NOT NULL,
  PRIMARY KEY (`idPedidos`),
  INDEX `fk_Pedidos_PEdiDomicilio1_idx` (`PEdiDomicilio_idPEdiDomicilio` ASC) VISIBLE,
  INDEX `fk_Pedidos_Detalles_Producto1_idx` (`Detalles_Producto_id_Detalle_Producto` ASC) VISIBLE,
  CONSTRAINT `fk_Pedidos_PEdiDomicilio1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Pedidos_Detalles_Producto1`
    FOREIGN KEY (`Detalles_Producto_id_Detalle_Producto`)
    REFERENCES `Pizzeria`.`Detalles_Producto` (`id_Detalle_Producto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Clientes` (
  ...
  INDEX `fk_Clientes_Pedidos1_idx` (`Pedidos_idPedidos` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Tipo_Producto` (
  ...
  INDEX `fk_Tipo_Producto_Detalles_Producto1_idx` (`Detalles_Producto_id_Detalle_Producto` ASC) VISIBLE,
  CONSTRAINT `fk_Tipo_Producto_Categorias_Pizzas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Tipo_Producto_Detalles_Producto1`
    FOREIGN KEY (`Detalles_Producto_id_Detalle_Producto`)
    REFERENCES `Pizzeria`.`Detalles_Producto` (`id_Detalle_Producto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
